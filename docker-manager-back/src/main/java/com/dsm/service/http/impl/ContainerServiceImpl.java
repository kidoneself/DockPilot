...
//    }
    ...
    public CompletableFuture<String> updateContainerImage(String containerId, MessageCallback callback) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            callback.onLog("【原容器】已重命名：" + backupName);
